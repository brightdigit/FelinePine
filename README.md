...
**FelinePine** provides an easy to use API for importing a **WordPress** site into **Publish**.
...
**FelinePine** uses the exported XML (also referred to as WXR file) to import content into your existing **Publish** site. 
...
**FelinePine** needs a backup XML file from your **WordPress** site. To do this:

1. Login to your WordPress Administration Dashboard.
2. Go to Tools... Export:
![WordPress-Tools...Export](Sources/FelinePine/Documentation.docc/Resources/tools-export-download-file.png)
...
Larger sites will include more than one XML file to ensure that your export process will be fast and complete successfully, for instance if you are running multi-site **WordPress**. Luckily **FelinePine** supports importing multiple xml files! 
...
![Example Copy of the WordPress Site's Files](Sources/FelinePine/Documentation.docc/Resources/wordpress-site-files.png "Example Copy of the WordPress Site's Files")
...
By default, **FelinePine** will download the images from your active **WordPress** site. Therefore if it comes across a reference to url to your site it will change the url to the new address it will be imported to.
...
By default, **FelinePine** doesn't implement any specific method to convert HTML from your WordPress posts to markdown. 
